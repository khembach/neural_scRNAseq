...
## Load NES data and map symbold to Ensembl IDs
```{r process-NES-data}
...
<!-- # # /home/Shared_taupo/data/annotation/Human/Ensembl_GRCh37.71/gtf/Homo_sapiens.GRCh37.71.gtf -->
<!-- # gtf <- import("/home/Shared_taupo/data/annotation/Human/GRCH37/gencode_v19/gencode.v19.annotation.gtf") -->
<!-- # # gtf <- import("/home/Shared_taupo/data/annotation/Human/Ensembl_GRCh37.71/gtf/Homo_sapiens.GRCh37.71.gtf") -->
<!-- # gene <- gtf[gtf$type == "gene"] -->
<!-- # map <- data.frame(gene_id = gtf$gene_id, gene_name = gtf$gene_name) -->
<!-- # map <- unique(map) -->
<!-- # -->
<!-- # ## we map the gene symbols to Ensembl IDs -->
<!-- # m <- match(rownames(sce_nes), map$gene_name) -->
<!-- # table(is.na(m)) -->
<!-- # rowData(sce_nes)$symbol <- rownames(sce_nes) -->
<!-- # rowData(sce_nes)$ensembl_id <- gene$gene_id[m] -->
<!-- # ## GRCH37/gencode_v19 -->
<!-- # FALSE  TRUE -->
<!-- # 12616  1470 -->
