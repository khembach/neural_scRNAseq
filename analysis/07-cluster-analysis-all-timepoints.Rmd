...
```{r paper-figures, fig.width = 12, fig.height = 6}
#  SOX2 and NQO1 (NSCs), GFAP (astrocytic), PTPRZ1 (OPCs), DCN (pericytes), SYP (neuronal), SLC32A1 (GABAergic) or SLC17A6 (Glutamatergic)
...
ps <- lapply(names(genes)[1:4], function(i) {
 ...
 ps <- lapply(names(genes)[5:8], function(i) {
        FeaturePlot(sub, features = genes[[i]], reduction = "umap", pt.size = 0.4,
